              ...
              <div class="row">
                  ...
                  <div class="single-horizontal-timeline">
                    <div className="card p-1 shadow mt-5">
                      <h4 className="text-center">
                        <a href="https://www.facebook.com/atangan.mea">
                          <img src={fb}></img>
                          <h4>Facebook</h4>
                        </a>
                ...
                <div class="col-md-4 text-center mb-3">
                  <div class="single-horizontal-timeline">
                    <div className="card p-1 shadow mt-5">
                      <h4 className="text-center">
                        <a href="https://www.tiktok.com/@miya7_a?_t=8nWTHBgvIVE&_r=1">
                          <img src={tiktok}></img>
                          <h4>Tiktok</h4>
                        </a>
                        <h5>@miya7_a</h5>
                ...
                <div class="col-md-4 text-center mb-3">
                  <div class="single-horizontal-timeline">
                    <div className="card p-1 shadow mt-5">
                      <h4 className="text-center">
                        <a href="https://www.instagram.com/meaatangan?ighs=a29vdHBjODNhYjVm">
            ...
            <div className="footer-info">
              <div className="col">
                <p>
                  ...
                  <a href="atanganmea4@gmail.com "> atanganmea4@gmail.com</a>
                </p>
              </div>
            </div>
          </div>
